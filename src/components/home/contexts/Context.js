import { Typography, Box, Link,  withStyles } from '@mui/material';
import Term from '../../../assets/images/terms/terms.png';
import Policy from '../../../assets/images/terms/policy.png';
import Cookies from '../../../assets/images/terms/cookies.png';
            ...
            data: 
                <Box>
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(c) Attempt to gain unauthorized access to or otherwise interfere or disrupt other computer systems or networks connected to the Platform or Services;
                        <br/><br/>(d) Post, promote or transmit through the Platform or Services any Prohibited Materials;
                        <br/><br/>(e) Interfere with another's utilization and enjoyment of the Platform or Services;
                        <br/><br/>(f) Use or upload, in any way, any software or material that contains, or which you have reason to suspect that contains, viruses, damaging components, malicious code or harmful components which may impair or corrupt the Platform’s data or damage or interfere with the operation of another Customer’s computer or mobile device or the Platform or Services; and
                        <br/><br/>(g) Use the Platform or Services other than in conformance with the acceptable use policies of any connected computer networks, any applicable Internet standards and any other applicable laws.
                        <br/><br/><br/>Availability of Platform and Services: We may, from time to time and without giving any reason or prior notice, upgrade, modify, suspend or discontinue the provision of or remove, whether in whole or in part, the Platform or any Services and shall not be liable if any such upgrade, modification, suspension or removal prevents you from accessing the Platform or any part of the Services.
                        <br/><br/><b>Right, but not obligation, to monitor content: We reserve the right, but shall not be obliged to:</b>
                        <br/><br/>(a) Monitor, screen or otherwise control any activity, content or material on the Platform and/or through the Services. We may in our sole and absolute discretion, investigate any violation of the terms and conditions contained herein and may take any action it deems appropriate;
                        <br/><br/>(b) Prevent or restrict access of any Customer to the Platform and/or the Services;
                        <br/><br/>(c) Report any activity it suspects to be in violation of any applicable law, statute or regulation to the appropriate authorities and to co-operate with such authorities; and/or
                        <br/><br/>(d) To request any information and data from you in connection with your use of the Services and/or access of the Platform at any time and to exercise our right under this paragraph if you refuse to divulge such information and/or data or if you provide or if we have reasonable grounds to suspect that you have provided inaccurate, misleading or fraudulent information and/or data.
                        <br/><br/><br/>Privacy Policy: Your use of the Services and/or access to the Platform is also subject to the Privacy Policy as set out here.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(a) to access and/or use the Services only for lawful purposes and in a lawful manner at all times and further agree to conduct any activity relating to the Services in good faith; and
                        <br/><br/>(b) to ensure that any information or data you post or cause to appear on the Platform in connection with the Services is accurate and agree to take sole responsibility for such information and data.
                        <br/><br/><br/>Product description: While we endeavor to provide an accurate description of the Products, we do not warrant that such description is accurate, current or free from error.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(c) That the Platform, the Services or the Materials are free from any computer virus or other malicious, destructive or corrupting code, agent, program or macros; and
                        <br/><br/>(d)The security of any information transmitted by you or to you through the Platform or the Services, and you accept the risk that any information transmitted or received through the Services or the Platform may be accessed by unauthorized third parties and/or disclosed by us or our officers, employees or agents to third parties purporting to be you or purporting to act under your authority. Transmissions over the Internet and electronic mail may be subject to interruption, transmission blackout, delayed transmission due to internet traffic or incorrect data transmission due to the public nature of the Internet.
                        <br/><br/><br/>Exclusion of liability: Indemnities shall not be liable to you for any Losses whatsoever or howsoever caused (regardless of the form of action) arising directly or indirectly in connection with:
                        <br/><br/>(a) Any access, use and/or inability to use the Platform or the Services;
                        <br/><br/>(b) Reliance on any data or information made available through the Platform and/or through the Services. You should not act on such data or information without first independently verifying its contents;
                        <br/><br/>(c) any system, server or connection failure, error, omission, interruption, delay in transmission, computer virus or other malicious, destructive or corrupting code, agent program or macros; and
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>1.1 “Customer” has the same meaning as in the Terms & Conditions of Sale.
                        <br/><br/>1.2 “Intellectual Property” means all copyright, patents, utility innovations, trademarks and service marks, geographical indications, domain names, layout design rights, registered designs, design rights, database rights, trade or business names, rights protecting trade secrets and confidential information, rights protecting goodwill and reputation, and all other similar or corresponding proprietary rights and all applications for the same, whether presently existing or created in the future, anywhere in the world, whether registered or not, and all benefits, privileges, rights to sue, recover damages and obtain relief or other remedies for any past, current or future infringement, misappropriation or violation of any of the foregoing rights.
                        <br/><br/>1.3 “POFSIS Indemnities” means POFSIS and all of its respective officers, employees, directors, agents, contractors and assigns.
                        <br/><br/>1.4 “POFSIS”, “we”, “our” and “us” refer to POFSIS, i4one Inc. a company incorporated pursuant to the laws of Philippines having its registered address at 2005B 20th Floor West, Philippine Stock Exchange Centre,1605 Exchange Rd, Ortigas Center, Pasig, Metro Manila.
                        <br/><br/>1.5 “Listing Price” means the price of Products listed for sale to Customers, as stated on the Platform.
                        <br/><br/>1.6 “Losses” means all penalties, losses, settlement sums, costs (including legal fees and expenses on a solicitor-client basis), charges, expenses, actions, proceedings, claims, demands and other liabilities, whether foreseeable or not.
                        <br/><br/>1.7 “Materials” means, collectively, all web pages on the Platform, including the information, images, links, sounds, graphics, video, software, applications and other materials displayed or made available on the Platform and the functionalities or services provided on the Platform.
                        <br/><br/>1.8 “Order” means your order for Products sent through the Platform in accordance with the Terms & Conditions of Sale.
                        <br/><br/>1.9 “Password” refers to the valid password that a Customer who has an account with POFSIS may use in conjunction with the Username to access the relevant Platform and/or Services.
                        <br/><br/>1.10 “Personal Data” means data, whether true or not, that can be used to identify, contact or locate you. Personal Data can include your name, e-mail address, billing address, shipping address, phone number and credit card information. “Personal Data” shall be deemed to include any data that you have provided to us when placing an Order, regardless of whether you have an account with us.
                        <br/><br/>1.11 “Platform” means (a) both the web and mobile versions of the website operated and/or owned by POFSIS which is presently located at the following URL: <Link href="https://pofsis.com" target="_blank">https://pofsis.com</Link>; and (b) the mobile applications made available from time to time by POFSIS, including the iOS and Android versions.
                        <br/><br/>1.12 “Privacy Policy” means the privacy policy set out Here
                        <br/><br/>1.13 “Product” means a product (including any installment of the product or any parts thereof) available for sale to Customers on the Platform.
                        <br/><br/>1.14 “Prohibited Material” means any information, graphics, photographs, data and/or any other material that:
                        <br/><br/>(a) contains any computer virus or other invasive or damaging code, program or macro;
                        <br/><br/>(b) infringes any third-party Intellectual Property or any other proprietary rights;
                        <br/><br/>(c) is defamatory, libelous or threatening;
                        <br/><br/>(d) is obscene, pornographic, indecent, counterfeited, fraudulent, stolen, harmful or otherwise illegal under the applicable law; and/or
                        <br/><br/>(e) is or may be construed as offensive and/or otherwise objectionable, in our sole opinion.
                        <br/><br/>1.15 “Services” means services, information and functions made available by us at the Platform.
                        <br/><br/>1.16 “Submission” is as defined above of these Terms of Use.
                        <br/><br/>1.17 “Terms & Conditions of Sale” means the terms and conditions governing a Customer’s purchase of the Products and are set out Here
                        <br/><br/>1.18 “Terms of Use” means the recitals and any Schedules to these terms and conditions.
                        <br/><br/>1.19 “Trademarks” means the trademarks, service marks, trade names and logos used and displayed on the Platform, including the POFSIS trademark, which is property of i4one Inc.
                        <br/><br/>1.20 “Username” refers to the unique login identification name or code which identifies a Customer who has an account with POFSIS.
                        <br/><br/>1.21 “Voucher” means a voucher for credit which may be used by a Customer, subject to other terms and conditions, towards the payment of purchases on the Platform.
                        <br/><br/>1.22 “you” and “your” refer to the individuals over the age of 18 or otherwise under the supervision of a parent or legal guardian.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>Decompilation, which is understood here to be the reproduction of the code and translation of the forms of the computer program to achieve the inter-operability of an independently created computer program with other programs may also constitute fair use. In determining whether the use made of a work in any particular case is fair use, the factors to be considered shall include:
                        <br/><br/>(a) The purpose and character of the use, including whether such use is of a commercial nature or is for non-profit educational purposes;
                        <br/><br/>(b) The nature of the copyrighted work;
                        <br/><br/>(c) The amount and substantiality of the portion used in relation to the copyrighted work as a whole; and
                        <br/><br/>(d) The effect of the use upon the potential market for or value of the copyrighted work.
                    </Typography>
                </Box>
        }
    ],
            ...
            data:
                <Box>
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(b) Contact data, such as billing address, delivery address, email address and phone numbers;
                        <br/><br/>(c) Account data, such as bank account and payment details;
                        <br/><br/>(d) Transaction data, such as details about purchases and payments to and from you, and other details of products, systems and services that you have purchased or obtained through the Platform;
                        <br/><br/>(e) Technical data, such as internet protocol (IP) address, your login data, browser type and version, time zone setting and location, browser plug-in types and versions, operating system and platform, international mobile equipment identity, device identifier, and other information and technology on the devices you use to access the Platform;
                        <br/><br/>(f) Profile data, such as your username and password, purchases made by you, your interests, preferences, feedback and survey responses;
                        <br/><br/>(g) Usage data, such as information on how you use the Platform, products, systems and services or view any content on the Platform;
                        <br/><br/>(h) Location data, such as when you capture and share your location with us in the form of photographs or videos and upload such content to the Platform;
                        <br/><br/>(i) Biometric data, such as voice files when you use our voice search function, and facial and other bodily features and voice of yourself and/or another other person featured in your video when you upload videos onto the Platform; and
                        <br/><br/>(j) Marketing and communications data, such as your preferences in receiving marketing from us and our third parties and your communication preferences.
                        <br/><br/><br/><br/>During the course of your use of the Platform and the provision of the Services, we may receive personal data from you in the following situations:
                        <br/><br/>(a) When you create an account with us;
                        <br/><br/>(b) When you apply for any of the Services or purchase any products available on the Platform;
                        <br/><br/>(c) When you use any of the features or functions available on the Platform or Services;
                        <br/><br/>(d) When you record any user-generated content which is uploaded on the Platform;
                        <br/><br/>(e) When you use the chat function on the Platform;
                        <br/><br/>(f) When you subscribe to our publications or marketing collaterals;
                        <br/><br/>(g) When you enter a competition, promotion or survey;
                        <br/><br/>(h) When you participate in any activity or campaign on the Platform;
                        <br/><br/>(i) When you log in to your account on the Platform or otherwise interact with us via an external service or application, such as Facebook or Google;
                        <br/><br/>(j) When any other user of the Platform posts any comments on the content you have uploaded on the Platform or when you post any comments on other users’ content uploaded to the Platform;
                        <br/><br/>(k) When a third-party lodges a complaint against you or the content you have posted on the Platform;
                        <br/><br/>(l) When you access or use mobile games (including our augmented reality games) on the Platform; and
                        <br/><br/>(m) When you interact with us offline, including when you interact with our outsourced customer service agents.
                        <br/><br/><br/><br/>During the course of your use of the Platform and the provision of the Services, you expressly consent to the transfer of your personal data from third parties to <Link sx={{ color: '#0070ef' }} href="https://pofsis.com" target="_blank">https://pofsis.com</Link> for the purposes set out in this Privacy Policy or any other terms.
                        <br/><br/>You must only submit personal data which is accurate and not misleading, and you must keep it up to date and inform us of any changes to the personal data you have provided to us. We shall have the right to request for documentation to verify the personal data provided by you as part of our customer verification processes.
                        <br/><br/>We will only be able to collect your personal data if you voluntarily submit the personal data to us or as otherwise provided for under this Privacy Policy. Unfortunately, if you choose not to submit your personal data to us or subsequently withdraw your consent to our use of your personal data, we may not be able to provide you with the Services or access to the Platform.
                        <br/><br/>You may access and update your personal information submitted to us at any time as described below.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(c) To process purchases you submit through the Platform (Payments that you make through the Platform for products and systems or tools, whether sold by us or a third-party seller, will be processed by our agent);
                        <br/><br/>(d) To provide the products / systems you have purchased through the Platform, whether sold by us or a third-party seller. We may pass your personal information on to a third party in order to process the products / systems to you (for example to payment facility), whether the product is sold through the Platform by us or a third-party partners;
                        <br/><br/>(e) To update you on the process of the products, whether sold through the Platform by us or a third-party partner’s, and for client support purposes;
                        <br/><br/>(f) To compare information, and verify with third parties in order to ensure that the information is accurate;
                        <br/><br/>(g) To ascertain your identity for fraud detection purposes;
                        <br/><br/>(h) To facilitate the takedown of prohibited and controlled items from our Platform;
                        <br/><br/>(i) To administer your account (if any) with us;
                        <br/><br/>(j) To verify and carry out financial transactions in relation to payments you make online;
                        <br/><br/>(k) To audit the downloading of data from the Platform;
                        <br/><br/>(l) To improve the layout or content of the pages of the Platform and customize them for users;
                        <br/><br/>(m) To identify visitors on the Platform;
                        <br/><br/>(n) To carry out research on our users’ demographics and behavior;
                        <br/><br/>(o) To provide you with information we think you may find useful or which you have requested from us, including information about our or third party partner’s products and services, provided you have indicated that you have not objected to being contacted for these purposes;
                        <br/><br/>(p) To display your name, username or profile on the Platform;
                        <br/><br/>(q) To allow other users to identify you (via the "Discover New Friends" or any other similar function) as a user of the Service, to allow you to find other users and to connect with them on the Platform, and to support the socializing function of the Services;
                        <br/><br/>(r) To promote the Services and use information that you give to us, such as user-generated content (including video content) that you can choose to upload or broadcast on our Platform and will be accessible on the internet and may be shared by the public (the latter of which is not within our control), as part of our advertising and marketing campaigns to promote the Platform;
                        <br/><br/>(s) To process any complaints, feedback, enforcement action and take-down requests in relation to any content you have uploaded to the Platform;
                        <br/><br/>(t) To display on scoreboards on the Platform in relation to campaigns, mobile games or any other activity;
                        <br/><br/>(u) To derive further attributes relating to you based on personal data provided by you (whether to us or third parties), in order to provide you with more targeted and/or relevant information;
                        <br/><br/>(v) To send you marketing or promotional materials about our or third-party sellers’ products and services from time to time; and
                        <br/><br/>(w) We may also conduct automated decision-making processes in accordance with any of these purposes.
                        <br/><br/><br/><br/>For the avoidance of doubt, you acknowledge and consent to POFSIS sharing anonymous information such as but not limited to in the following circumstances:
                        <br/><br/>(a) Aggregated information. We may conduct joint data analytics projects with selected third-party providers using anonymized information to predict user interests and provide users with more targeted and/or relevant information based on aggregated information about that user’s activities outside the Platform
                        <br/><br/>(b) Behavioral-based advertising. We may collaborate with selected third parties using anonymized information to derive certain models that would facilitate more accurate advertising to selected users.
                        <br/><br/><br/><br/>You may unsubscribe from receiving marketing information at any time by using the unsubscribe function within the electronic marketing material. We may use your contact information to send newsletters from us and from our related companies.
                        <br/><br/>In exceptional circumstances, we may be required to disclose personal information, such as when there are grounds to believe that the disclosure is necessary to prevent a threat to life or health, or for law enforcement purposes, or for fulfillment of legal and regulatory requirements and requests.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(c) Request correction of inaccurate or erroneous personal data, unless such request is vexatious or unreasonable;
                        <br/><br/>(d) Request for reasonable access to your personal data; and
                        <br/><br/>(e) Request indemnification for damages sustained due to such inaccurate, incomplete, outdated, false, unlawfully obtained, or unauthorized use of personal data.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(c) Using 128-bit SSL (secure sockets layer) encryption technology when processing your financial details.
                        <br/><br/><br/>If you believe that your privacy has been breached by POFSIS, please contact us immediately.
                    ...
                    <Typography sx={{ fontFamily: 'Poppins'}} variant="body1">
                        ...
                        <br/><br/>(b) Browser type;
                        <br/><br/>(c) Webpage you were visiting before you came to the Platform;
                        <br/><br/>(d) The pages within the Platform which you visit; and
                        <br/><br/>(e) The time spent on those pages, items and data searched for on the Platform, access times and dates, and other statistics.
                        <br/><br/><br/><br/>This data is collected for analysis and evaluation in order to help us improve our website and the services and products we provide.
                        <br/><br/>Cookies are small text files (typically made up of letters and numbers) placed in the memory of your browser or device when you visit a website or view a message. They allow us to recognize a particular device or browser and help us to personalize the content to match your preferred interests more quickly, and to make the Services and the Platform more convenient and useful to you.
                        <br/><br/>You may be able to manage and delete cookies through your browser or device settings. For more information on how to do so, visit the help material of your browser or device.
    ...
    [
        {
            data: 
                <Box>
                    ...
                    <br/><br/><li>Third party analytics are used to track and measure usage of this site so that we can continue to produce engaging content. These cookies may track things such as how long you spend on the site or pages you visit which helps us to understand how we can improve the site for you.</li>
                    ...
                    <br/><br/><li>As we sell products it's important for us to understand statistics about how many of the visitors to our site actually make a purchase and as such this is the kind of data that these cookies will track. This is important to you as it means that we can accurately make business predictions that allow us to monitor our advertising and product costs to ensure the best possible price.</li>
                    <br/><br/><li>The Google AdSense service we use to serve advertising uses a DoubleClick cookie to serve more relevant ads across the web and limit the number of times that a given ad is shown to you.</li>
                    <br/><br/><br/>For more information on Google AdSense see the official Google AdSense privacy FAQ.
                    <br/><br/><li>We use adverts to offset the costs of running this site and provide funding for further development. The behavioural advertising cookies used by this site are designed to ensure that we provide you with the most relevant adverts where possible by anonymously tracking your interests and presenting similar things that may be of interest.</li>
